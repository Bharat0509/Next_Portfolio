...
const ContactMe = (props: Props) => {
    ...
    const handleSubmit = (e: any) => {
        e.preventDefault();
        window.location.href = `mailto:bharatbhammar001@gmail.com?subject=New Message From ${formData.name}&body=Hi,my name is ${formData.name}.${formData.desc}(${formData.email})`;
    };
    return (
        <motion.div
            initial={{ opacity: 0 }}
